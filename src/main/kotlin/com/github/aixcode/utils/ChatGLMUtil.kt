...
object ChatGLMUtil {
    ...
    private fun buildPrompt(prompt: String): String {
        val InputPrompt = """
         ...
         3.关键问题:详细介绍所讨论的技术或工具所解决的问题,思想起源,发展历史.
         4.问题解决:核心原理讲解,详细介绍所讨论的技术或工具解决方案核心思想和实现原理，以便读者了解其基本原理和实现方式。
         5.实战案例：提供实际操作的步骤和指南，包括如何设置环境、安装和配置所需的软件和库，以及如何使用它们来完成任务或实现功能。
         ...
         此外，文章的排版使用markdown格式,使用清晰的标题和段落、代码块和注释等，以便读者更容易地阅读和理解文章的内容。
         字数要求不少于5000字。
